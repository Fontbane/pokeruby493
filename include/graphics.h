...
extern const u8 gMonIcon_ShellosE[];
extern const u8 gMonFootprint_ShellosE[];
...
extern const u8 gMonIcon_GastrodonE[];
extern const u8 gMonFootprint_GastrodonE[];
...
extern struct CompressedSpritePalette gBattleAnimSpritePalette_291;
