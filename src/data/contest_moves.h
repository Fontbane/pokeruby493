...
const struct ContestMove gContestMoves[] = {
    ...
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_BEAUTY, 0, {COMBO_STARTER_WATER_SPORT, 0, 0, 0}}, // AQUA_JET
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_SMART, 0, {COMBO_STARTER_POUND, 0, 0, 0}}, // DOUBLE_HIT
    {CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS, CONTEST_CATEGORY_SMART, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // NASTY_PLOT
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // NIGHT_SLASH
    {CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // DARK_PULSE
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_SMART, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // SUCKER_PUNCH
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_BEAUTY, 0, {COMBO_STARTER_FAKE_OUT, COMBO_STARTER_LEER, COMBO_STARTER_POUND, 0}}, // FEINT
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // OMINOUS_WIND
    {CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_SCARY_FACE, 0, 0, 0}}, // SHADOW_SNEAK
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_DRAGON_BREATH, COMBO_STARTER_DRAGON_RAGE, COMBO_STARTER_DRAGON_DANCE, 0}}, // DRAGON_RUSH
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_BEAUTY, COMBO_STARTER_FIRE_PUNCH, {COMBO_STARTER_SUNNY_DAY, COMBO_STARTER_THUNDER_PUNCH, COMBO_STARTER_ICE_PUNCH, 0}}, // FIRE_FANG
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_BEAUTY, COMBO_STARTER_ICE_PUNCH, {COMBO_STARTER_THUNDER_PUNCH, COMBO_STARTER_FIRE_PUNCH, 0, 0}}, // ICE_FANG
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, COMBO_STARTER_THUNDER_PUNCH, {COMBO_STARTER_CHARGE, COMBO_STARTER_FIRE_PUNCH, COMBO_STARTER_ICE_PUNCH, 0}}, // THUNDER_FANG
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_BEAUTY, 0, {COMBO_STARTER_CALM_MIND, 0, 0, 0}}, // AURA_SPHERE
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_TOUGH, 0, {COMBO_STARTER_LOCK_ON, 0, 0, 0}}, // CLOSE_COMBAT
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_SMART, COMBO_STARTER_DRAGON_BREATH, {COMBO_STARTER_DRAGON_RAGE, COMBO_STARTER_DRAGON_DANCE, 0, 0}}, // DRAGON_PULSE
    {CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_FOCUS_ENERGY, 0, 0, 0}}, // FORCE_PALM
    ...
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_TOUGH, 0, {COMBO_STARTER_GROWTH, 0, 0, 0}}, // WOOD_HAMMER
    ...
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // ROCK_WRECKER
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // STONE_EDGE
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // GIGA_IMPACT
    {CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {COMBO_STARTER_SUNNY_DAY, 0, 0, 0}}, // LAVA_PLUME
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_COOL, 0, {COMBO_STARTER_FOCUS_ENERGY, 0, 0, 0}}, // PSYCHO_CUT
    ...
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_BEAUTY, COMBO_STARTER_FOCUS_ENERGY, {0, 0, 0, 0}}, // SPACIAL_REND
