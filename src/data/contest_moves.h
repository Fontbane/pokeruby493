...
const struct ContestMove gContestMoves[] = {
    ...
    {CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS, CONTEST_CATEGORY_CUTE, 0, {COMBO_STARTER_NASTY_PLOT, 0, 0, 0}}, // BATON_PASS
    ...
    {CONTEST_EFFECT_STARTLE_PREV_MON, CONTEST_CATEGORY_SMART, 0, {0, COMBO_STARTER_FORCE_PALM, 0, 0}}, // SMELLING_SALT
    ...
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // DOUBLE_HIT
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // NASTY_PLOT
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_COOL, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // NIGHT_SLASH
    ...
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {0, COMBO_STARTER_CHARGE, 0, 0}}, // THUNDER_FANG
    ...
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BRINE
    ...
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_BEAUTY, 0, {0, COMBO_STARTER_CHARGE, 0, 0}}, // DISCHARGE
    ...
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // STONE_EDGE
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // GIGA_IMPACT
    {CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // LAVA_PLUME
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // PSYCHO_CUT
    ...
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_BEAUTY, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // SPACIAL_REND
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // MAGMA_STORM
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // SHADOW_CLAW
    ...
    {CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // ROOST
    {CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // GUNK_SHOT
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_COOL, 0, {0, COMBO_STARTER_FOCUS_ENERGY, 0, 0}}, // CROSS_POISON
    ...
    {CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // LEAF_STORM
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // ROCK_POLISH
    {CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS, CONTEST_CATEGORY_BEAUTY, 0, {0, COMBO_STARTER_CHARGE, 0, 0}}, // CHARGE_BEAM
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // AVALANCHE
