...
struct Evolution gEvolutionTable[NUM_SPECIES][7] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_HELD_ITEM_NIGHT, ITEM_OVAL_STONE, SPECIES_ESPEON},
                            {EVO_HELD_ITEM_NIGHT, ITEM_LIGHT_BALL, SPECIES_UMBREON},
    ...
    [SPECIES_SHELLOSE]   = {{EVO_LEVEL, 30, SPECIES_GASTRODONE}},
